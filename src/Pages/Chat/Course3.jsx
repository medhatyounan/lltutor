...
const Course3 = () => {
  ...
  const fetchChatHistory = async () => {
    ...
    let config = {
      method: 'get',
      maxBodyLength: Infinity,
      url: `https://8d2f-156-210-15-233.ngrok-free.app/chat/SD/?session_id=${session_id}`,
      headers: { "ngrok-skip-browser-warning": "69426"}
    };
  ...
  const fetchHistoryList = async () => {
    try {
      const response = await axios.get('https://lltutor.runasp.net/chats/3', {
  ...
  const sendMessage = async (message) => {
    ...
    let config = {
      method: 'post',
      maxBodyLength: Infinity,
      url: 'https://8d2f-156-210-15-233.ngrok-free.app/chat/SD/',
      headers: { 
        'Content-Type': 'application/json',
        "ngrok-skip-browser-warning": "69427"
      },
      data: data
    };
          ...
          <div id='chatAiBody-container' className='col-9'>
            <div className='chatAiBody'>
              ...
              <div className='chatTitle row'>
                <div className='col-2 fs-3 fw-bolder letter-space-1'>System Design</div>
