...
const Course4 = () => {
  ...
  const fetchChatHistory = async () => {
    ...
    let config = {
      method: 'get',
      maxBodyLength: Infinity,
      url: `http://127.0.0.1:8082/chat/wolfram/?session_id=${session_id}`,
      headers: {}
    };
  ...
  const fetchHistoryList = async () => {
    try {
      const response = await axios.get('https://lltutor.runasp.net/chats/4', {
  ...
  const sendMessage = async (message) => {
    ...
    let config = {
      method: 'post',
      maxBodyLength: Infinity,
      url: 'http://127.0.0.1:8082/chat/wolfram/',
      headers: { 
        'Content-Type': 'application/json'
      },
      data: data
          ...
          <div id='chatAiBody-container' className='col-9'>
            <div className='chatAiBody'>
              ...
              <div className='chatTitle row'>
                <div className='col-2 fs-3 fw-bolder letter-space-1'>Mathematics</div>
